...
export default function AuthPage() {
  ...
  // Login form (handles only username and password)
  ...
  // Registration form (handles username, password, and domain)
      ...
      <div className="flex-1 flex items-center justify-center">
        <Card className="w-[350px]">
          <CardHeader>
            ...
            <CardDescription>Sign in to access the anonymous messaging platform</CardDescription>
          </CardHeader>
          <CardContent>
